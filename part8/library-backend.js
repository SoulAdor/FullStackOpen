...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
      ...
      if (args.author) resultBooks = resultBooks.filter (book => book.author === args.author)
      if (args.genre) resultBooks = resultBooks.filter (book => book.genres.includes(args.genre))
      return resultBooks
    },
    allAuthors: () => authors
  },
